...
namespace WallyAndynaswebApp.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        // GET: Usuarios; sirve para listar los datos
        ...
        public async Task<IActionResult> Create([Bind("Id,Cuenta,Contraseña,NombreCompleto,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cuenta,Contraseña,NombreCompleto,Rol")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
